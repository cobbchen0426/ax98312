...
#define SCREG_1ED      0x08//(SC_ADC_BAND_GAP|BIT3)

#if ENABLE_LD == ON
#define SCREG_1ED_INIT     0x08//(SC_ADC_BAND_GAP|BIT3|BIT0)  
#else
#define SCREG_1ED_INIT      0x08//(SC_ADC_BAND_GAP|BIT3|BIT1|BIT0)
#endif
