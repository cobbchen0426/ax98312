...
#define PANEL_TYPE              (AUO|RES_1280X800)		// 1280x720@50
...
#define PANEL_TYP_HTOTAL        1632 //1632
#define PANEL_MAX_HTOTAL        1600	//1470

#define PANEL_MIN_VTOTAL        742	//815
#define PANEL_TYP_VTOTAL        744	//790	//823
#define PANEL_MAX_VTOTAL        800	//800	//1023

#define PANEL_HSYNC_WIDTH       20	//128 //32	// ((PANEL_MIN_HTOTAL - PANEL_WIDTH) / 3 / 8) * 8
#define PANEL_HSYNC_BACKPORCH   54	//176 //80 //george ((PANEL_MIN_HTOTAL - PANEL_WIDTH) / 3 / 8) * 8
#define PANEL_HACTIVE_BEG       PANEL_HSYNC_WIDTH + PANEL_HSYNC_BACKPORCH

#define PANEL_VSYNC_WIDTH       5  //7
#define PANEL_VSYNC_BACKPORCH   16 //20
...
#define PANEL_FRC_OUTPUT_VSYNC  500	//600 //0.1Hz
